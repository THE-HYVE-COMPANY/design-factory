...
Subfolder used by [`docs/SMOKE-RUNBOOK.md`](../docs/SMOKE-RUNBOOK.md)
steps 9 and 10. Stable, minimal artefacts that exercise the importer
flow without relying on third-party design.md URLs or whatever ZIPs
