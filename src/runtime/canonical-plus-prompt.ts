...
const STOP_ADJECTIVE: Record<DialKey, Record<keyof DialDirection, string>> = {
  ...
  interactions: { extremeLow: "read-only", softLow: "quiet-i",   softHigh: "playful",   extremeHigh: "tactile" },
  surface:      { extremeLow: "paper",     softLow: "flat",      softHigh: "tactile-s", extremeHigh: "skeu" },
