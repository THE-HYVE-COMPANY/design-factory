...
id: review
label: Review
description: Honest critique of the current design
category: evaluate
hue: cool-blue
modifiesHtml: false
icon: eye
...
4. Spot anti-patterns: side-stripe borders, gradient text, decorative glassmorphism, hero-metric template clichés, identical-card grids, modal-as-first-thought, filler copy, AI-shimmer haze gradients.
...
- A short scorecard line at the end (e.g. `Hierarchy 7 · Palette 5 · Type 6 · Content 4 · Polish 6`).
- End with one concrete next step the user should take if they only have 5 minutes.

Tone: a colleague who respects the user, not a hype machine. No emoji. No "great work!". No false praise. If something is bad, say it's bad and why.
