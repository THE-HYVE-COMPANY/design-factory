...
You are introducing color into an existing design that's currently monochromatic, neutral-only, or color-shy. The goal is *strategic* color — used to direct attention, signal hierarchy, or carry brand identity — not decoration.
