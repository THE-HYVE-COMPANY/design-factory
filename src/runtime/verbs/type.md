...
Method
1. **Establish a scale** — pick a deliberate scale (geometric, modular, or musical-fifths) and apply it to *every* text size. No one-off font-size values. Common starting scales:
