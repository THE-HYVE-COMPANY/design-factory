  ...
  return (
    <DfModal open={open} onClose={onClose} size="lg" title={title} foot={footer}>
      <div className="pc-body" style={bodyStyle}>
        ...
        {/* System prompt preamble — workspace bindings + agent
          * contract + DS markdown. This is the chrome the agent reads
          * before the user's first message. Long; lives in a
          * collapsable region. */}
        {systemPreamble ? (
        ...
        {/* Compiled direction (the markdown block the runtime ships) */}
