        ...
        <div style={{
          ...
          <p style={{
            ...
            <code style={{
              ...
              border: "1px solid var(--df-border-subtle)",
              borderRadius: 3,
            }}>{this.state.error.name}</code>: {this.state.error.message}
          </p>
          ...
          <div style={{ display: "flex", gap: 8, marginTop: "var(--df-sp-2)", flexWrap: "wrap" }}>
            <button className="df-btn df-btn--primary" onClick={this.handleReload}>Reload app</button>
            <button className="df-btn df-btn--secondary" onClick={this.handleHome}>Back to home</button>
            <button className="df-btn df-btn--ghost" onClick={this.handleCopy}>Copy diagnostics</button>
          </div>
        </div>
      </div>
    );
