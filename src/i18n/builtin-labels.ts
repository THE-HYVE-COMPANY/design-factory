...
// Titles for the 50 visual-taste defaults (user ask 2026-05-29 to total
// 50 brand-agnostic visual rules). The EN value here MUST match the
// canonical `title` field on the rule in rules-taxonomy.ts — that file is
// the source of truth for the EN copy, and the `pick()` fallback picks EN
// from this map when lang === "en" to keep the i18n table self-contained.
const RULE_TITLES: Record<string, Pair> = {
  ...
  "as-no-default-glassmorphism": { pt: "Sem glassmorphism por default",    en: "No default glassmorphism" },
  ...
  "ly-consistent-alignment-edges":{ pt: "Bordas de alinhamento consistentes", en: "Consistent alignment edges" },
  ...
  "ty-comfortable-measure":       { pt: "Medida e entrelinha confortáveis", en: "Comfortable measure & leading" },
  "ty-one-or-two-typefaces":      { pt: "Uma ou duas fontes",              en: "One or two typefaces" },
  "ty-weight-for-hierarchy":      { pt: "Hierarquia por peso, não por cor", en: "Weight for hierarchy, not color" },
  ...
  // Color
  "co-honor-existing-palette":    { pt: "Honrar a paleta existente",       en: "Honor the existing palette" },
  ...
  "co-semantic-colors-consistent":{ pt: "Cores semânticas consistentes",   en: "Consistent semantic colors" },
  "co-desaturate-large-fills":    { pt: "Dessaturar áreas grandes",        en: "Desaturate large fills" },
  // Depth
  "de-soft-consistent-shadows":   { pt: "Sombras suaves e consistentes",   en: "Soft, consistent shadows" },
  "de-hairline-borders":          { pt: "Bordas hairline, baixo contraste", en: "Hairline, low-contrast borders" },
  ...
  "mo-no-decorative-spinners":    { pt: "Sem spinner decorativo infinito", en: "No decorative spinners" },
  "mo-honor-reduced-motion":      { pt: "Respeitar reduced-motion",        en: "Honor reduced motion" },
  "mo-quick-subtle-timing":       { pt: "Tempos curtos e easing consistente", en: "Quick, subtle timing" },
  ...
  "im-consistent-treatment":      { pt: "Tratamento de imagem uniforme",   en: "Consistent image treatment" },
  "im-overlay-for-legibility":    { pt: "Overlay pra texto sobre imagem",  en: "Overlay for text on images" },
  ...
  "ic-icons-clarify-not-decorate":{ pt: "Ícone esclarece, não enfeita",    en: "Icons clarify, not decorate" },
  // Forms
  ...
  "st-disabled-reads-disabled":   { pt: "Disabled parece disabled",        en: "Disabled reads as disabled" },
  "st-selected-distinct-from-hover": { pt: "Selecionado distinto do hover", en: "Selected distinct from hover" },
};
