...
export const DEFAULT_BUILTIN_DIALS: Record<DialKey, DialDirection> = Object.freeze({
  density: {
    extremeLow: "Radical restraint — gallery whitespace, minimum elements per surface, near-empty canvas.",
    ...
    extremeHigh:"Maximum density — pack every visible element, brutalist info-fill, no decorative gaps.",
  },
  motion: {
    extremeLow: "Inert composition — no transitions, no hover lifts, no scroll-driven animation, static.",
    ...
    extremeHigh:"Choreographed motion — rich transitions, parallax, scroll-tied sequences, every interaction tactile.",
  },
  contrast: {
    extremeLow: "Whisper contrast — single-tone palette, near-imperceptible hierarchy, monastic restraint.",
  ...
  interactions: {
    ...
    softHigh:   "Playful interaction — interactive elements visible everywhere, hover/active states present.",
    extremeHigh:"Fully tactile — every element responds, micro-interactions celebrated, instrument-like feedback.",
  },
  surface: {
    ...
    extremeHigh:"Skeuomorphic — deep bezels, inset highlights, ambient drops, instrument-grade tactility.",
  },
  originality: {
