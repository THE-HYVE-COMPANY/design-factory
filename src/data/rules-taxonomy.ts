...
//
// User ask 2026-05-29: "totalizar 50 regras visuais que façam qualquer
// design ficar melhor automaticamente." This pass drops the previous
// 30 (which mixed in copy, agent-behaviour and engineering rules plus
// brand-flavoured aesthetics) and replaces them with 50 brand-agnostic
// VISUAL taste defaults across 10 categories. No copy/voice/process
// rules; nothing tied to any specific brand.
//
