...
export const ALLOWED_BRIDGE_ORIGINS = [
  "http://localhost:1420",
  "http://127.0.0.1:1420",
  // Tauri webview/window origins — the desktop build serves the app from these.
  // macOS uses tauri://localhost; Windows (WebView2) serves over
  // http://tauri.localhost (confirmed on a real Windows build — http, not https).
  "tauri://localhost",
